...
public static class IdentityApiEndpointRouteBuilderExtensions
{
        ...
        where TUser : class, new()
    {
        ...
        accountGroup.MapGet("/info", async Task<Results<Ok<IdentityInfoResponse>, ValidationProblem, NotFound>>
        ...
        accountGroup.MapPost("/info", async Task<Results<Ok<IdentityInfoResponse>, ValidationProblem, NotFound>>
    ...
    private static async Task<IdentityInfoResponse> CreateInfoResponseAsync<TUser>(TUser user,
        UserManager<TUser> userManager)
        where TUser : class
    {
        return new(
            Guid.Parse(await userManager.GetUserIdAsync(user)),
